...
for i in range(len(titles)):
    print(f"{i + 1}. Title: {titles[i]}; Comments: {comments[i]};")

# Сохранение данных в data.json
data = [{"Title": titles[i], "Comments": comments[i]} for i in range(len(titles))]
...
# Создание структуры HTML-документа с помощью BeautifulSoup4
...
headers = ['Title', 'Amount of Comments', '№']
